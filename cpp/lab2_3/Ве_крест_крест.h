...
#define много std::vector
#define добавить push_back
#define отрезать_крайний pop_back
...
#define двинуть move
#define грезный virtual
#define переведать override
...
хутор Сибирь
{
	...
	свет_мой_зеркальце <скажи Тип>
	РавнобокоеДрево<Тип>::РавнобокоеДрево(приказ_княжий РавнобокоеДрево<Тип>& засланец)
	{
	...
	РавнобокоеДрево<Тип>& РавнобокоеДрево<Тип>::оператор = (приказ_княжий РавнобокоеДрево<Тип>&засланец)
	{
		...
		свет_мой_зеркальце <скажи Тип>
		РавнобокоеДрево<Тип>::РавнобокоеДрево(РавнобокоеДрево<Тип>&& засланец)
		{
